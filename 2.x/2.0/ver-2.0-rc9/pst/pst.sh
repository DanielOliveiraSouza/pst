...
# Versão:2.0.9-r16-11-2016
# Descrição: Script de configuração geral do sistema apt com proxy de linux baseado em debian
# * Integridade do script 
#
versao='2.0.9-r16-11-2016'
trivial_install="gcc kate konsole codeblocks build-essential checkinstall cdbs devscripts dh-make fakeroot libxml-parser-perl check avahi-daemon freeglut3 freeglut3-dev libglew1.5 libglew1.5-dev libglu1-mesa libglu1-mesa-dev libgl1-mesa-dev  swi-prolog "
...
default_install=$default_install"php5 openjdk-7-jdk libapache2-mod-php5 "
...
xenial_install=$xenial_install"php7.0 openjdk-8-jdk libapache2-mod-php7.0 "
		...
		*"Ubuntu"*)
			...
			case "$linux_release" in
				...
				*"14.04"*)
				...
				;;
				*"15."*)
					echo 'Esta versão não é mais suportada, atualize para o ubuntu 16.04'
					exit 1
				;;
